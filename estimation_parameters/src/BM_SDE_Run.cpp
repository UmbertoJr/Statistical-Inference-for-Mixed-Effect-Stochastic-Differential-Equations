...
int main() {
	...
	start_run = clock();  // fa partire il timer 
	...
	end_run = clock();  // stop per il timer e print del tempo algoritmo
	time_run = (double) (end_run - start_run)/ CLOCKS_PER_SEC ;
	std::cout << "\n\n######  time execution total algorithm is: " << time_run << "  #######" << std::endl;
